...
# ------------------ Chat with Bard API  ------------------ #
# chat = ChatBard(token=bard_api_key, language='en')
# print(chat._get_api_key)
# chat.start()

# ------------------ Text To Speech(TTS) ------------------ #
# audio = bard.speech('Hello, Welcome to my youtube channel, I am very excited to make this video for Bard APIs')
# with open("speech.ogg", "wb") as f:
#   f.write(bytes(audio['audio']))

# ------------------ GET Cookie from Browser via Python ------------------ #
